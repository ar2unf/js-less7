...
class Game {
    ...
    doTick() {
        ...
        if (this.is_snake_stepped_to_self()) {
            return;
        }
        if (this.isGameWon()) {
            return;
...
class Settings {
     ...
     */
    init(params) {
        let defaultParams = {rowsCount: 15, colsCount: 15, speed: 2, winLength: 50};
...
class Snake {
    ...
    performStep() {
        ...
        // проверки выхода за края игрового поля
        // правый
